...
| しおり | `x=56, w=12`, 上辺 `y=0` で断ち切り、下端 `y=83`、V ノッチ頂点 `(62,76)` | `#D8503F` |

安全領域への収まりは、アイコン中心 (54,54) から各頂点までの距離で判定する。本の左上角 (36,27) が 32.4dp、しおりの右下角 (68,83) が 32.2dp で、これが全要素中の最外点である。いずれも 33dp の内側に収まる。

この設計の律速はしおりの右下角である。しおりを右に寄せるほど、また下に伸ばすほど、この点は円の外へ向かう。本を 40×53dp に拡大した場合、本の左上角は 35.2dp、しおりの右下角は 36.7dp となり、後者は円マスクの半径 36dp すら超えて実際に欠ける。
